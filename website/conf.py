...
extensions = ['sphinx.ext.autodoc', 'sphinx.ext.imgmath', 'sphinx.ext.autosummary', 'sphinx.ext.intersphinx', 'sphinx.ext.extlinks']
#  'sphinx.ext.viewcode'] #'sphinx.ext.jsmath',
...
project = u'pyFormex'
copyright = u'2004-2021, Benedict Verhegghe'
